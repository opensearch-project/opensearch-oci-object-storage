...
@Log4j2
class OciMultiPartObjectStorageBlobStore implements OciBlobStore {
    ...
    OciMultiPartObjectStorageBlobStore(
     ...
     */
    @Override
    public Map<String, BlobMetadata> listBlobs(String path) throws IOException {
    ...
    @Override
    public Map<String, BlobContainer> listChildren(BlobPath path) throws IOException {
     ...
     */
    @Override
    public DeleteResult deleteDirectory(String pathStr) throws IOException {
